...
func (c *primaryServiceClient) PrintNested(context *rpc.Context, request map[string]map[string][][]map[string]*Color) (map[string]map[string][][]map[string]*Color, *rpc.Error) {
	var response map[string]map[string][][]map[string]*Color = make(map[string]map[string][][]map[string]*Color)
	err := c.client.Send(context, c.name, "print_nested", request, &response)
	return response, err
}
...
func (s *primaryServiceServer) printNested(context *rpc.Context, d *disorder.Decoder) (interface{}, *rpc.Error) {
	var request map[string]map[string][][]map[string]*Color = make(map[string]map[string][][]map[string]*Color)
	err := d.Decode(&request)
	if err != nil {
		return nil, &rpc.Error{
			Code:  code.InvalidRequest,
